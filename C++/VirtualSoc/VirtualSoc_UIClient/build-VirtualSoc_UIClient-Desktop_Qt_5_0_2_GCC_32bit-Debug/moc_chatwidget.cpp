...
#include "../VirtualSoc_UIClient/Classes/chatwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ChatWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 31, 24)
    ...
    "ChatWidget\0on_sendBtn_clicked\0\0"
...
void ChatWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_disconnectBtn_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ChatWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ChatWidget.data,
      qt_meta_data_ChatWidget,  qt_static_metacall, 0, 0}
};
...
void *ChatWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ChatClientListener"))
        return static_cast< ChatClientListener*>(const_cast< ChatWidget*>(this));
