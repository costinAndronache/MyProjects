...
#include "../VirtualSoc_UIClient/Classes/ApiComunicator/userinfowidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_UserInfoWidget_t, stringdata) + ofs \
...
const QMetaObject UserInfoWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_UserInfoWidget.data,
      qt_meta_data_UserInfoWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UserInfoWidget.stringdata))
        return static_cast<void*>(const_cast< UserInfoWidget*>(this));
    if (!strcmp(_clname, "ApiComunicatorListener"))
        return static_cast< ApiComunicatorListener*>(const_cast< UserInfoWidget*>(this));
