...
#include "../VirtualSoc_UIClient/Classes/groupwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_GroupWidget_t, stringdata) + ofs \
...
const QMetaObject GroupWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GroupWidget.data,
      qt_meta_data_GroupWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GroupWidget.stringdata))
